...
**Next task:** 0.11, the Expo mobile skeleton. It needs a decision on Android tooling: this laptop cannot run an emulator alongside everything else, so use a physical phone with a development build. Then Phase 1 (identity & admin).
